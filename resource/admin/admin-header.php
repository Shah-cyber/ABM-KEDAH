...
<div class="profile-popup" id="profilePopup">
            <ul>
                ...
                <li><a href="#profile" class="profilepopup-options"><img src="../img/task.png"><span class="px-2">My Task</span></a></li>
                <li class="text-center signoutlist"><a class="signoutbtn text-decoration-none" href="../homepage/homepage.php">Sign Out</a></li>
            </ul>
        </div>
</header>