                        ...
                        <form id="admin-updatemeritform" method="POST" enctype="multipart/form-data">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="merit_points" name="merit_points" value="<?php echo isset($merit['merit_point']) ? htmlspecialchars($merit['merit_point']) : '0'; ?>" required>
                                </div>
                            </div>
